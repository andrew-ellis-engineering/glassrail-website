...
export const replays: Replay[] = [
  {
    ...
    events: [
      ...
      { t: 1650, e: "plan_ready", text: "plan_ready" },
  ...
  },
  {
    ...
    plan: {
      nodes: [
        ...
        { id: 4, type: "result", label: "Final answer", layer: 2, deps: [2, 3] }
      ]
    },
    events: [
      { t: 0, e: "planning_started", text: "planning_started" },
      { t: 1450, e: "plan_ready", text: "plan_ready" },
  ...
  },
  {
    ...
    plan: {
      nodes: [
        { id: 1, type: "tool", label: "Search release notes", layer: 0, deps: [] },
        { id: 2, type: "summary", label: "Condense sources", layer: 1, deps: [1] },
        { id: 3, type: "result", label: "Answer with citation", layer: 2, deps: [2] }
      ]
    },
    events: [
      { t: 0, e: "planning_started", text: "planning_started" },
      { t: 1500, e: "plan_ready", text: "plan_ready" },
      { t: 5600, e: "node_started", node: 1, text: "web_search args" },
      ...
      { t: 11200, e: "node_started", node: 3, text: "result with citation" },
